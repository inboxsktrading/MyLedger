...
async function suggestCategory() {
    ...
    try {
        ...
        const suggestions = {
            'food': ['restaurant', 'groceries', 'takeout'],
            'transport': ['gas', 'uber', 'taxi', 'public transport'],
            'bills': ['electricity', 'water', 'internet', 'phone']
        };
        
        // Simple matching - in a real app you'd use more sophisticated logic
        let category = 'Other';
        Object.entries(suggestions).forEach(([mainCat, keywords]) => {
        ...
        transactionCategoryInput.value = category.charAt(0).toUpperCase() + category.slice(1);
    } catch (error) {
